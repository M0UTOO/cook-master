...
use App\Controllers\Users;
    ...
    echo form_open_multipart($action, 'id="event-create-form" class=""', $hidden_input);
                ...
                $value = (isset($contractor) ? $contractor['email'] :'');
                ...
                $value = (isset($contractor) ? $contractor['firstname'] :'');
                ...
                $value = (isset($contractor) ? $contractor['lastname'] :'');
                ...
                echo '<div class="form-group mb-3">';
                echo form_label(lang('Common.presentation') , "label-event-name");
                $value = (isset($contractor) ? $contractor['presentation'] :'');
                echo form_input(['type'  => 'text', 'name'  => 'presentation', 'class' => 'form-control', 'value' => $value, 'placeholder' => lang('Common.presentation')]);
                echo '</div>';
